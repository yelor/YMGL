 ...
 * @author huiqi
 */
public class YiMiaoSheGouTuiHuoJDialog extends BaseDialog {

    private static final Logger logger = Logger.getLogger(YiMiaoSheGouTuiHuoJDialog.class);
     ...
     */
    public YiMiaoSheGouTuiHuoJDialog() {
        super();
        init();
        initComponents();
        jTextFieldXiaoshouTuihuoId.setText(DanHao.getDanHao("YMSGTH"));
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.jskj.asset.client.AssetClientApp.class).getContext().getResourceMap(YiMiaoSheGouTuiHuoJDialog.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(com.jskj.asset.client.AssetClientApp.class).getContext().getActionMap(YiMiaoSheGouTuiHuoJDialog.class, this);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jTextFieldConstactperson, javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(YiMiaoSheGouTuiHuoJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                YiMiaoSheGouTuiHuoJDialog dialog = new YiMiaoSheGouTuiHuoJDialog();
    ...
    public void print() {
        try {
            super.print(this.getTitle(),
                    ...
                    {"退货单位", jTextFieldSupplierName.getText()},
    ...
    private class SubmitFormTask extends XiaoshoutuihuoTask {
        ...
        public void onSucceeded(Object result) {
            ...
            AssetMessage.INFO("提交成功！", YiMiaoSheGouTuiHuoJDialog.this);
            exit();
        }
    }
    
      public YiMiaoSheGouTuiHuoJDialog(final JDialog parent, XiaoshoutuihuoxiangdanEntity yimiaoxiaoshoutuihuoxiangdanEntity) {
        super();
        initComponents();
        ...
        jTextFieldXiaoshouTuihuoId.setEditable(false);
        jTextFieldXiaoshouTuihuoId.setText(yimiaoxiaoshoutuihuoxiangdanEntity.getBacksaletb().getBacksaleId());
        jTextFieldzhidanDate.setEditable(false);
        ...
        total=0;
        for(int i=0;i<yimiaoxiaoshoutuihuoxiangdanEntity.getResult().size();i++){
            total+=yimiaoxiaoshoutuihuoxiangdanEntity.getResult().get(i).getBacksale_detail_tb().getTotalprice();
        }
        totalPrice.setText("" + total + "元");
