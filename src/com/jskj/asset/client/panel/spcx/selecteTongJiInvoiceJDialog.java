...
public class selecteTongJiInvoiceJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "固定资产领用统计表", "固定资产维修统计表", "低值易耗品领用统计表", "Ⅰ类疫苗领用单明细表", "Ⅱ类疫苗采购单明细表", "固定资产采购单明细表", "低值易耗品采购单明细表", "Ⅰ类疫苗下发单明细表", "Ⅱ类疫苗销售单明细表", "疫苗库存汇总表", "固定资产库存汇总表", "低值易耗品库存汇总表", "盘点单统计表" }));
