 ...
 * @author huiqi
 */
public class WeiXiuFeiYongTongJiJDialog extends javax.swing.JDialog {

    /**
     * Creates new form WeiXiuFeiYongTongJiJDialog
     */
    public WeiXiuFeiYongTongJiJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.jskj.asset.client.AssetClientApp.class).getContext().getResourceMap(WeiXiuFeiYongTongJiJDialog.class);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "资产编号", "资产名称", "规格", "型号", "品牌", "购置日期", "保修期至", "使用人", "使用部门", "维修单号", "取回时间", "维修情况", "维修金额", "返回状况"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WeiXiuFeiYongTongJiJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                WeiXiuFeiYongTongJiJDialog dialog = new WeiXiuFeiYongTongJiJDialog(new javax.swing.JFrame(), true);
