...
public class OtherShouKuanDanJDialog extends BaseDialog {
    ...
    public OtherShouKuanDanJDialog(java.awt.Frame parent, boolean modal) {
        ...
        final BaseTable.SingleEditRowTable editTable = ((BaseTable) jTable1).createSingleEditModel(new String[][]{
            {"zhichuType", "收入类别", "true"}, {"userName", "经办人", "true"},
        ...
        editTable.registerPopup(1, new IPopupBuilder() {
            ...
            public void setBindedMap(HashMap bindedMap) {
                if (bindedMap != null) {
                    ...
                    Qitashoukuanliebiaotb fk = new Qitashoukuanliebiaotb();
                    fk.setShoukuandanId(shoukuandanId.getText());
...
//        }
        ...
        skd.setTotalprice(total * (100 - Float.parseFloat(zhekou.getText())) / 100);
