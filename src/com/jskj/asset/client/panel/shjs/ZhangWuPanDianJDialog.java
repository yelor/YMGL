 ...
 * @author huiqi
 */
public class ZhangWuPanDianJDialog extends javax.swing.JDialog {

    /**
     * Creates new form yimiaoyanshouJDialog
     */
    public ZhangWuPanDianJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        init();
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.jskj.asset.client.AssetClientApp.class).getContext().getResourceMap(ZhangWuPanDianJDialog.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(com.jskj.asset.client.AssetClientApp.class).getContext().getActionMap(ZhangWuPanDianJDialog.class, this);
        ...
        jTable4.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "资产编号", "资产名称", "资产类别", "型号", "规格", "单位", "品牌", "数量", "单价", "账务库存", "实盘库存", "盘盈数量", "盘亏数量", "备注"
            }
        ));
        ...
        if (jTable4.getColumnModel().getColumnCount() > 0) {
            ...
            jTable4.getColumnModel().getColumn(10).setHeaderValue(resourceMap.getString("jTable4.columnModel.title12")); // NOI18N
            jTable4.getColumnModel().getColumn(11).setHeaderValue(resourceMap.getString("jTable4.columnModel.title13")); // NOI18N
            jTable4.getColumnModel().getColumn(12).setHeaderValue(resourceMap.getString("jTable4.columnModel.title14")); // NOI18N
            jTable4.getColumnModel().getColumn(13).setHeaderValue(resourceMap.getString("jTable4.columnModel.title15")); // NOI18N
        }
