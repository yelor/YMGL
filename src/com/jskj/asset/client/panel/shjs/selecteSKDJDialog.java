...
public class selecteSKDJDialog extends javax.swing.JDialog {
    private ShouKuanDanJDialog skdJDialog;
    private OtherShouKuanDanJDialog otherskdJDialog;
    ...
    public void ChooseAction() {
        ...
        if (aa==0) {
            ...
            skdJDialog = new ShouKuanDanJDialog(new javax.swing.JFrame(), true);
            skdJDialog.setLocationRelativeTo(mainFrame);
            }
            AssetClientApp.getApplication().show(skdJDialog);
        } else {
            if (otherskdJDialog == null) {
            JFrame mainFrame = AssetClientApp.getApplication().getMainFrame();
            otherskdJDialog = new OtherShouKuanDanJDialog(new javax.swing.JFrame(), true);
