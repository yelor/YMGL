 ...
 * @author huiqi
 */
public class YMFuKuanDanJDialog extends BaseDialog {

    private final static Logger logger = Logger.getLogger(YMFuKuanDanJDialog.class);
    private int userId;
    ...
    public YMFuKuanDanJDialog() {
        ...
        fukuandanId.setText(DanHao.getDanHao(DanHao.TYPE_YMFK));
    ...
    public YMFuKuanDanJDialog(final JDialog parent, FukuanshenqingDetailEntity detail) {
        super();
        initComponents();
...
//        }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.jskj.asset.client.AssetClientApp.class).getContext().getResourceMap(YMFuKuanDanJDialog.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(com.jskj.asset.client.AssetClientApp.class).getContext().getActionMap(YMFuKuanDanJDialog.class, this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(YMFuKuanDanJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
