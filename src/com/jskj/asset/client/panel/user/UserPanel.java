...
public final class UserPanel extends BasePanel {
    ...
    public UserPanel() {
        ...
        bindTable.bind().setColumnWidth(new int[]{0, 100}, new int[]{1, 100}, new int[]{2, 100}, new int[]{3, 100}, new int[]{4, 200}, new int[]{5, 200}, new int[]{6, 220}, new int[]{7, 150}).setRowHeight(30);
