 ...
 * @author huiqi
 */
public class YimiaoyunshujiluPanel extends BasePanel {

    private final static Logger logger = Logger.getLogger(YimiaoyunshujiluPanel.class);
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.jskj.asset.client.AssetClientApp.class).getContext().getResourceMap(YimiaoyunshujiluPanel.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(com.jskj.asset.client.AssetClientApp.class).getContext().getActionMap(YimiaoyunshujiluPanel.class, this);
