 ...
 * @author huiqi
 */
public class YimiaorukujiluPanel extends BasePanel {

    private final static Logger logger = Logger.getLogger(YimiaorukujiluPanel.class);
