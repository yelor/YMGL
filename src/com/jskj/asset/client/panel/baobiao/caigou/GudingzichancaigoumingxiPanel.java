 ...
 * @author huiqi
 */
public class GudingzichancaigoumingxiPanel extends BasePanel {

    private final static Logger logger = Logger.getLogger(GudingzichancaigoumingxiPanel.class);
     ...
     */
    public GudingzichancaigoumingxiPanel() {
        super();
        initComponents();
        pageIndex = 1;
        pageSize = 20;
    ...
    private void initComponents() {
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(com.jskj.asset.client.AssetClientApp.class).getContext().getActionMap(GudingzichancaigoumingxiPanel.class, this);
        jButton12.setAction(actionMap.get("print")); // NOI18N
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.jskj.asset.client.AssetClientApp.class).getContext().getResourceMap(GudingzichancaigoumingxiPanel.class);
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    ...
                    .addComponent(jLabel1)))
            .addComponent(jToolBar1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    public Task print() {
        ...
        ReportCaiGouFindTask printData = new ReportCaiGouFindTask(printMap, "report/list") {
            ...
            public void responseResult(CommFindEntity response) {
                bindTable.createPrinter("固定资产采购明细报表", response.getResult()).buildInBackgound().execute();
            }
        };
        return printData;
    }
    ...
    public Task disDetail() {
        ...
        return new ReportCaiGouGDZCTask(selectedData);
    }
}
