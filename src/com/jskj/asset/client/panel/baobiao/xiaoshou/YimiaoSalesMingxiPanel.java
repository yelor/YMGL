 ...
 * @author huiqi
 */
public class YimiaoSalesMingxiPanel extends BasePanel {
    ...
    private List<SalesReport> currentPageData;

    private final BindTableHelper<SalesReport> bindTable;
     ...
     * @param IDFlag
     */
    public YimiaoSalesMingxiPanel(String IDFlag) {
        super();
        initComponents();
        pageIndex = 1;
        pageSize = 20;
        count = 0;
        this.IDFlag = IDFlag;
        bindTable = new BindTableHelper<SalesReport>(jTable1, new ArrayList<SalesReport>());
        bindTable.createTable(new String[][]{{"saleDate", "制单日期"}, {"danjuleixing", "单据类别"}, {"saleId", "单据编号"}, {"suppliertb.supplierName", "客户单位"}, {"usertball.department.departmentName", "部门"},
        {"usertball.userName", "制单人"}, {"remark", "描述"}});
        ...
        parameterMap.put("idflag", IDFlag);
    ...
    private void initComponents() {
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(com.jskj.asset.client.AssetClientApp.class).getContext().getActionMap(YimiaoSalesMingxiPanel.class, this);
        jButton12.setAction(actionMap.get("print")); // NOI18N
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.jskj.asset.client.AssetClientApp.class).getContext().getResourceMap(YimiaoSalesMingxiPanel.class);
    ...
    public SalesReport selectedDataFromTable() {
    ...
    public List<SalesReport> getTableData() {
        return currentPageData;
    }

    private class RefreshTask extends ReportSalesFindTask {

        RefreshTask(HashMap parameterMap) {
            super(parameterMap, "report/sales/list");
        }

        @Override
        public void responseResult(CommFindEntity<SalesReport> response) {
    ...
    public Task print() {
        ...
        ReportCaiGouFindTask printData = new ReportCaiGouFindTask(printMap, "report/list") {
            ...
            public void responseResult(CommFindEntity response) {
                String str = "疫苗销售明细报表";
                if(IDFlag.startsWith(DanHao.TYPE_YIMIAOXF)){
                   str = "疫苗下发明细报表";
                }
                bindTable.createPrinter(str, response.getResult()).buildInBackgound().execute();
            }
        };
        return printData;
    }
    ...
    public Task disDetail() {
        SalesReport selectedData = selectedDataFromTable();
        if (selectedData == null) {
            AssetMessage.ERRORSYS("请选择一条数据!");
            return null;
        }
        return new ReportSalesYimiaoTask(selectedData);
    }
}
