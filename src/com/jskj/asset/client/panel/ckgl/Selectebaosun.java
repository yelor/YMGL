 ...
 */
public class Selectebaosun extends BaseDialog {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.jskj.asset.client.AssetClientApp.class).getContext().getResourceMap(Selectebaosun.class);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Selectebaosun.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Selectebaosun dialog = new Selectebaosun();
    ...
    public void putongwupinbaosunAction() {
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                dispose();
                JFrame mainFrame = AssetClientApp.getApplication().getMainFrame();
                PuTongBaoSun putongbaosun = new PuTongBaoSun();
