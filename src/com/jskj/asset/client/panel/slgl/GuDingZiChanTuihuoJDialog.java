 ...
 * @author tt
 */
public class GuDingZiChanTuihuoJDialog extends BaseDialog {

    public static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(GuDingZiChanTuihuoJDialog.class);
     ...
     * @param modal
     */
    public GuDingZiChanTuihuoJDialog() {
        super();
        initComponents();
        ...
        cgsqId.setText(DanHao.getDanHao(DanHao.TYPE_ZCTH));
        ...
        editTable.registerPopup(1, new IPopupBuilder() {
            ...
            public String getConditionSQL() {
                ...
                String sql = "";
                sql += " cgsq_id like \"" + DanHao.TYPE_ZCCT +"%\" and is_completed = 1 and status = 10 ";
    ...
    public GuDingZiChanTuihuoJDialog(final JDialog parent,CaigoushenqingDetailEntity detail){
        super();
        initComponents();
        this.detail = detail;
        this.addWindowListener(new WindowListener(){
    ...
    private class Cancel extends CancelDengji{
        ...
        public void onSucceeded(Object object) {
            ...
            GuDingZiChanTuihuoJDialog zichanchuku = new GuDingZiChanTuihuoJDialog();
    ...
    public Task submitForm() throws ParseException{
        if(jTable1.getRowCount()-1 < 1){
            AssetMessage.ERRORSYS("请选择要退货的资产！",this);
            return null;
        }
...
//        for (int i = 0; i < zc.size(); i++) {
        for (int i = 0; i < jTable1.getRowCount()-1; i++) {
            ...
            if(zclb.getQuantity() > kucun){
                AssetMessage.ERRORSYS("第" + (i+1) + "个资产的退货数量大于库存数："+kucun+"，退货失败！");
                return null;
            }
        ...
        return new CommUpdateTask<ChukudanDetailEntity>(cgsq,serviceId) {
            ...
            public void responseResult(ComResponse<ChukudanDetailEntity> response) {
                if (response.getResponseStatus() == ComResponse.STATUS_OK) {
                    ...
                    AssetMessage.ERROR(response.getErrorMessage(), GuDingZiChanTuihuoJDialog.this);
                }
            }
        };
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.jskj.asset.client.AssetClientApp.class).getContext().getResourceMap(GuDingZiChanTuihuoJDialog.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(com.jskj.asset.client.AssetClientApp.class).getContext().getActionMap(GuDingZiChanTuihuoJDialog.class, this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GuDingZiChanTuihuoJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GuDingZiChanTuihuoJDialog dialog = new GuDingZiChanTuihuoJDialog();
