...
public class GuDingZiChanRuKuJDialog extends BaseDialog{
    ...
    public static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(GuDingZiChanRuKuJDialog.class);
     ...
     * @param modal
     */
    public GuDingZiChanRuKuJDialog() {
        super();
        initComponents();
    ...
    private class CloseTask extends WeidengjizichanTask{
        ...
        public void responseResult(CommFindEntity<ZichanliebiaotbAll> response) {
            ...
            if (list != null && list.size() > 0) {
                ...
                string.append("是否继续入库？选“否或“取消”会要求输入原因，并不再入库以上所有资产");
...
//        for (int i = 0; i < zc.size(); i++) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GuDingZiChanRuKuJDialog dialog = new GuDingZiChanRuKuJDialog();
