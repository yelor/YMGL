 ...
 * @author huiqi
 */
public class selectShenHeDanJDialog extends javax.swing.JDialog {
    

    /**
     * Creates new form selecteInvoiceJDialog
     */
    public selectShenHeDanJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.jskj.asset.client.AssetClientApp.class).getContext().getResourceMap(selectShenHeDanJDialog.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(com.jskj.asset.client.AssetClientApp.class).getContext().getActionMap(selectShenHeDanJDialog.class, this);
