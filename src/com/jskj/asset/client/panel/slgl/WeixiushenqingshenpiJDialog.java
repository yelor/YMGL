...
//        bindTable.setIntegerType(1);
    ...
    private class RefreshTask extends WeixiushenqingchaxunTask {
        ...
        public void onSucceeded(Object object) {
            ...
            WeixiushenqingFindEntity sq = (WeixiushenqingFindEntity) object;
    ...
    private class SPTask extends WeixiushenqingShenpiTask{
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.jskj.asset.client.AssetClientApp.class).getContext().getResourceMap(WeixiushenqingshenpiJDialog.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(com.jskj.asset.client.AssetClientApp.class).getContext().getActionMap(WeixiushenqingshenpiJDialog.class, this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WeixiushenqingshenpiJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                WeixiushenqingshenpiJDialog dialog = new WeixiushenqingshenpiJDialog(new javax.swing.JFrame(),true);
