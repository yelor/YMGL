 ...
 * @author tt
 */
public class GuDingZiChanChuZhiJDialog extends javax.swing.JDialog {
     ...
     */
    public GuDingZiChanChuZhiJDialog(java.awt.Frame parent) {
        super(parent);
        init();
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.jskj.asset.client.AssetClientApp.class).getContext().getResourceMap(GuDingZiChanChuZhiJDialog.class);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "资产编码", "资产名称", "资产类型", "规格", "型号", "单位", "数量", "单价", "合价"
            }
        ) {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(ctrlPane, javax.swing.GroupLayout.DEFAULT_SIZE, 822, Short.MAX_VALUE)
            .addComponent(bottomPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 822, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GuDingZiChanChuZhiJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GuDingZiChanChuZhiJDialog dialog = new GuDingZiChanChuZhiJDialog(new javax.swing.JFrame());
