...
public class ITGuDingZiChanLingYongShenQingJDialog extends BaseDialog {
    ...
    public static final Logger logger = Logger.getLogger(ITGuDingZiChanLingYongShenQingJDialog.class);
     ...
     */
    public ITGuDingZiChanLingYongShenQingJDialog() {
        super();
        initComponents();
        ...
        cgsqId.setText(DanHao.getDanHao(DanHao.TYPE_ITLY));
...
//                    zc.add(zclb);
    ...
    public ITGuDingZiChanLingYongShenQingJDialog(final JDialog parent, CaigoushenqingDetailEntity detail) {
        super();
        initComponents();
        this.detail = detail;
...
//        for (int i = 0; i < zc.size(); i++) {
    ...
    private void initComponents() {
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(com.jskj.asset.client.AssetClientApp.class).getContext().getActionMap(ITGuDingZiChanLingYongShenQingJDialog.class, this);
