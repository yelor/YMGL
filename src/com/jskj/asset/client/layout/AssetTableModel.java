...
//
    ...
    private boolean cellCanEdit = true;
    private List<Integer> editColumn;
...
//
     ...
     * @see #setValueAt
     */
    public AssetTableModel(int rowCount, int columnCount) {
     ...
     * columns; if this is <code>null</code> then the model has no columns
     * @param rowCount the number of rows the table holds
     * @see #setDataVector
     * @see #setValueAt
     */
    public AssetTableModel(List columnNames, int rowCount) {
     ...
     * @see #setValueAt
     */
    public AssetTableModel(Object[] columnNames, int rowCount) {
     ...
     * @see #setDataVector
     */
    public AssetTableModel(List data, List columnNames) {
        this(data, columnNames, false, new ArrayList());
    }

    public AssetTableModel(List data, List columnNames, boolean cellCanEdit, List<Integer> editColumn) {
     ...
     * @see #setDataVector
     */
    public AssetTableModel(Object[][] data, Object[] columnNames) {
        setDataVector(data, columnNames);
    }
...
//    }
    ...
    public void addColumn(Object columnName, List columnData) {
        getColumnIdentifiers().add(columnName);
        if (columnData != null) {
...
//
    ...
    public String getColumnName(int column) {
        ...
        if (column < getColumnIdentifiers().size() && (column >= 0)) {
            id = getColumnIdentifiers().get(column);
        }
        if (id instanceof ColumnBean) {
            return ((ColumnBean) id).getColumnName();
        }
