 ...
 */
public class ReportImageTemplates {
	...
	static {
		...
		dynamicReportsComponent =
		  cmp.horizontalList(
		  	cmp.image(ReportImageTemplates.class.getResource("images/dynamicreports.png")).setFixedDimension(60, 60),
		  	cmp.verticalList(
		  		cmp.text(Constants.WINTITLE).setStyle(bold22CenteredStyle).setHorizontalAlignment(HorizontalAlignment.LEFT)
