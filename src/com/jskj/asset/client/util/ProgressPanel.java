 ...
 * @author woderchen
 */
public class ProgressPanel extends JComponent implements MouseListener {/** Contains the bars composing the circular shape. */
	...
	/**
	 * Creates a new progress panel by chenyf(2007/01/07)
	 *
	 * @param text
	 *            The message to be displayed. Can be null or empty.
	 * @param barsCount
	 ...
	 */
	public ProgressPanel(String text, int barsCount, float shield,
			float fps, int rampDelay, int width, int height) {
		this(text, barsCount, shield, fps, rampDelay);
		this.width = width;
		this.height = height;
	}
	...
	private Area[] buildTicker() {
		...
		Point2D.Double center = new Point2D.Double((double) this.width / 2,
